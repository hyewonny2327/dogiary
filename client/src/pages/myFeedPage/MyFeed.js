            ...
            {/* <MyFeedStyle> */}
                ...
                <CalendarContainer>
                    <div className='tab-container'>
                        <div onClick={()=>handleClickTab('calendar')} className={isCalendarClick ? 'clicked':''}>캘린더</div>
                        <div onClick={()=>handleClickTab('timeline')} className={isTimelineClick ? 'clicked' : ''}>타임라인</div>
                    </div>
                ...
                <LongColoredBtn onClick ={handleButtonClick}>추억 기록하기</LongColoredBtn> 
            {/* </MyFeedStyle> */}
        </MyFeedContainer>
        </FeedContainer>
    )
