        ...
        <PageContainer>
            ...
            <PostPageContainer>
                ...
                <Content>
                    <TitleContainer>
                    <InputBox>
                        <input className='title-box' type='text' placeholder='날짜를 입력하세요'></input>                            
                    </InputBox>
                    <InputBox>
                        <input className='title-box' type='text' placeholder='제목을 작성하세요'></input>                            
                    </InputBox>
                    </TitleContainer>
                    <ContentContainerBox>
                    {[...Array(count)].map((_, index) => (
                       <ContentBox key={index} uploadedImage={uploadedImage[index]} handleImageUpload={()=>handleImageUpload()}/>
                    ))}
                        
                    </ContentContainerBox>
                    <PlusIcon className='plus-icon'src={plusIcon} onClick={handleAddContent}/>
                </Content>
                <ButtonContainer>
...
export function ContentBox({uploadedImage,handleImageUpload}){
    ...
    return(
        <ContentContainer className='container'>
            ...
            <textarea className='input-box' type='text' placeholder='일기를 입력하세요'></textarea>                            
